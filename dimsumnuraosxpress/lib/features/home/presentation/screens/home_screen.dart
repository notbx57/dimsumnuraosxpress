...
class HomeScreen extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSectionHeader(context, 'Mitra Terdekat', () {}, showFilter: true),
              const SizedBox(height: 12),
  ...
  Widget _buildSectionHeader(BuildContext context, String title, VoidCallback onSeeAll, {bool showFilter = false}) {
    return Row(
    ...
    final List<Map<String, String>> promos = [
      {
        ...
        'subtitle': 'Berlaku sampai tengah malam • Dimsum Nuraos Xpress',
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          const Icon(Icons.favorite_border, color: AppColors.onSurfaceVariant),
                        ],
                      ),
                      const SizedBox(height: 8),
                      Text(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.receipt_long, 'Pesanan', false, () => context.push('/tracking')),
          _buildNavItem(Icons.shopping_basket, 'Keranjang', false, () => context.push('/menu')),
