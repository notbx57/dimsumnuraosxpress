          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: AppTextStyles.headlineLg.copyWith(fontSize: 24, color: AppColors.primary),
              ),
              const SizedBox(height: 8),
              Text(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                ...
                style: AppTextStyles.labelMd.copyWith(fontSize: 15, fontWeight: FontWeight.bold),
              ),
          ...
          Row(
            children: [
              Expanded(
                child: _buildTipButton('2000', 'Rp 2.000'),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildTipButton('5000', 'Rp 5.000'),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildTipButton('custom', 'Kustom'),
              ),
            ],
          ),
        ],
