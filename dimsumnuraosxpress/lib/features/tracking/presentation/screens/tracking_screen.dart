...
class _TrackingScreenState extends State<TrackingScreen> with SingleTickerProviderStateMixin {
      ...
      CurvedAnimation(parent: _animationController, curve: Curves.easeInOut),
        ...
        setState(() {
          ...
          if (progress < 0.4) {
            ...
            _driverStatus = 'Pengemudi sedang di perjalanan menuju alamat Anda';
          } else {
  ...
  Offset _getDriverPosition(double progress) {
    ...
    double t = progress;
    double x = (1 - t) * (1 - t) * merchantOffset.dx + 2 * (1 - t) * t * 0.55 + t * t * homeOffset.dx;
    double y = (1 - t) * (1 - t) * merchantOffset.dy + 2 * (1 - t) * t * 0.35 + t * t * homeOffset.dy;
    return Offset(x, y);
  }
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final Offset merchantPixel = Offset(merchantOffset.dx * width, merchantOffset.dy * height);
          final Offset homePixel = Offset(homeOffset.dx * width, homeOffset.dy * height);
          final Offset driverOffsetPercent = _getDriverPosition(_progressAnimation.value);
          final Offset driverPixel = Offset(driverOffsetPercent.dx * width, driverOffsetPercent.dy * height);
          ...
          return Stack(
            children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          ...
                          style: AppTextStyles.labelSm.copyWith(color: Colors.white, fontSize: 9),
                        ),
                      ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const Icon(Icons.home, color: AppColors.onBackground, size: 18),
                      ),
                    ],
                  ),
                ),
              ...
              // Dev cheat button to skip animation
              Positioned(
                top: 16,
                right: 16,
                child: Opacity(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Simulasi Sampai'),
                  ),
                ),
              )
            ],
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          'Budi',
                          style: AppTextStyles.labelMd.copyWith(fontSize: 16, fontWeight: FontWeight.bold),
                        ),
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                          decoration: BoxDecoration(
            ...
            children: [
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('Pesan', style: AppTextStyles.labelMd.copyWith(color: Colors.white)),
                    ],
                  ),
                ),
              ),
              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Menghubungi Telepon Budi...')),
                    );
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text('Telepon', style: AppTextStyles.labelMd.copyWith(color: AppColors.primary)),
                    ],
                  ),
                ),
              ),
